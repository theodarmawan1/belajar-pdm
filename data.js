      ...
      <div class="pdf-viewer-container">
        ...
        <div class="pdf-page-block" id="pdf-page-pdf" style="height: 700px; display: none;">
          <div class="pdf-page-header">
            <span>Berkas Dokumen Asli (https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/png2pdf.pdf)</span>
            <span class="pdf-page-num-badge">PDF Viewer</span>
          </div>
          <iframe class="pdf-viewer-iframe" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/png2pdf.pdf" width="100%" height="100%" style="border: 1px solid var(--border-glass); border-radius: var(--border-radius-md); background-color: #0b0f19;"></iframe>
        </div>
      ...
      <div class="embedded-pdf-viewer" id="viewer-mod-6">
        ...
        <div class="pdf-viewer-layout">
          <div class="pdf-viewer-sidebar">
            <div class="pdf-viewer-tab active" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/CRC%20Card%20Old%20patient.pdf" data-title="CRC Card Old Patient" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">CRC Card Old Patient</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Template%20CRC.pdf" data-title="Template CRC Card" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
...
flowchart TD
    ...
    UC4 -.->|"&lt;&lt;extend&gt;&gt;"| UC2
      ...
      <div class="embedded-pdf-viewer" id="viewer-mod-7">
        ...
        <div class="pdf-viewer-layout">
          <div class="pdf-viewer-sidebar">
            <div class="pdf-viewer-tab active" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Manage%20Appartement%20Availability.pdf" data-title="Manage Appartement Availability" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Manage Appartement Availability</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Use%20Case%20Description%20Old%20patient%20appointment.pdf" data-title="Old Patient Appointment Desc" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
...
classDiagram
    ...
    Book "0..*" --> "1" BookCollection : bagian dari (Agregasi)
      ...
      <div class="embedded-pdf-viewer" id="viewer-mod-9">
        ...
        <div class="pdf-viewer-layout">
          <div class="pdf-viewer-sidebar">
            <div class="pdf-viewer-tab active" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Class%20Diagram%20with%20Incorporated%20Pattern%20for%20the%20Library%20Book%20Collection%20System.drawio.pdf" data-title="Library Pattern Class Diagram" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Pattern Class Diagram</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Second-Cut%20Class%20Diagram%20for%20the%20Library%20Book%20Collection%20System.drawio.pdf" data-title="Second-Cut Class Diagram" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
...
stateDiagram-v2
    ...
    Available --> [*] : [Buku Dihapus dari Sirkulasi]
      ...
      <div class="embedded-pdf-viewer" id="viewer-mod-11">
        ...
        <div class="pdf-viewer-layout">
          <div class="pdf-viewer-sidebar">
            <div class="pdf-viewer-tab active" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Book%20State%20Diagram.drawio.pdf" data-title="Book State Diagram" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Book State Diagram</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Lunch%20State%20Machine%20Diagram.drawio.pdf" data-title="Lunch State Diagram" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Lunch State Diagram</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Order%20State%20Machine.drawio.pdf" data-title="Order State Diagram" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Order State Diagram</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Patient%20State%20Machine%20Diagram.drawio.pdf" data-title="Patient State Diagram" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
...
flowchart LR
    ...
    Librarian ---|4: CheckOverdueBookOrFine| Borrower[Borrower]
      ...
      <div class="embedded-pdf-viewer" id="viewer-mod-12">
        ...
        <div class="pdf-viewer-layout">
          <div class="pdf-viewer-sidebar">
            <div class="pdf-viewer-tab active" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Add%20appartment%20use%20case%2C%20sequence%20diagram.drawio.pdf" data-title="Add Apartment Sequence" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Add Apartment Sequence</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/BorrowBookSequenceDiagram.drawio.pdf" data-title="Borrow Book Sequence" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Borrow Book Sequence</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Sequence%20Diagram%20ATM.drawio.pdf" data-title="ATM Sequence Diagram" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">ATM Sequence Diagram</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Sequence%20Diagram%20Alan%20Denis%20Make%20Appointment.drawio.pdf" data-title="Make Appointment Sequence" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Make Appointment Sequence</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/CommunicationDiagramMakeAppt.drawio.pdf" data-title="Make Appointment Collaboration" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Make Appointment Collaboration</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/CommunicationDiagramValidIDcardButOweABook.drawio.pdf" data-title="Valid ID Check Collaboration" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
...
flowchart TD
    ...
    ServerArtifact -- Port 5432 Connection --> DB
      ...
      <div class="embedded-pdf-viewer" id="viewer-mod-13">
        ...
        <div class="pdf-viewer-layout">
          <div class="pdf-viewer-sidebar">
            <div class="pdf-viewer-tab active" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/Pd%20layer%20appointment%20system.drawio.pdf" data-title="Appointment System Pd Layer" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
              <span class="file-name">Pd Layer Appointment</span>
            </div>
            <div class="pdf-viewer-tab" data-src="https://xlgaihgb8il0clbc.public.blob.vercel-storage.com/PDF/TrackOrder.drawio.pdf" data-title="Track Order Package" data-type="pdf">
              <span class="file-icon pdf">PDF</span>
